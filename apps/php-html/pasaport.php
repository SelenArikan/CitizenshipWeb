...
$ctaDescriptions = [
    ...
    'fa' => 'می توانimy شرایط احراز, جریان مدارک و ترتیب ثبت پرونده را با هم بررسی کنیم.',
];
$ctaDescription = $ctaDescriptions[$lang] ?? 'Uygunluk, belge akışı ve başvuru sırasını birlikte değerlendirelim.';

$PASSPORT_ADVANTAGES_TEXT = <<<EOT
TÜRK PASAPORTUNUN AVANTAJLARI
...
Avrupa ve Balkanlar:
Kuzey Makedonya (90 gün / 180 gün içinde)
Arnavutluk (90 gün)
Sırbistan (90 gün / 180 gün içinde)
Bosna-Hersek (90 gün / 180 gün içinde)
Karadağ (90 gün / 180 gün içinde)
Kosova (90 gün / 180 gün içinde)
Moldova (90 gün)
Ukrayna (90 gün / 180 gün içinde — kimlik ile giriş mümkündür)
Belarus (30 gün — şartlı)
Kuzey Kıbrıs Türk Cumhuriyeti (90 gün — kimlik ile giriş mümkündür)

Asya:
Ürdün (90 gün / 180 gün içinde)
Azerbaycan (90 gün — kimlik ile giriş mümkündür)
Gürcistan (1 yıl — kimlik ile giriş mümkündür)
Kazakistan (30 gün)
Kırgızistan (90 gün / 180 gün içinde)
Katar (90 gün / 180 gün içinde)
İran (90 gün)
Lübnan (90 gün / 180 gün içinde)
Özbekistan (30 gün)
Moğolistan (30 gün)
Japonya (90 gün)
Güney Kore (90 gün — K-ETA zorunludur)
...
Fas (90 gün)
Tunus (90 gün)
Seyşeller (90 gün — Seyahat Yetkilendirmesi zorunludur)
Mauritius (30 gün)
Botsvana (90 gün)
Esvatini (30 gün)
Gambiya (90 gün)
Zambiya (30 gün, 90 güne kadar uzatılabilir)
Angola (30 gün)
São Tomé ve Príncipe (15 gün)

Güney ve Orta Amerika ile Karayipler:
Arjantin (90 gün)
Antigua ve Barbuda (90 gün)
Brezil (90 gün)
Kolombiya (90 gün)
Panama (90 gün)
Guatemala (90 gün)
Şili (90 gün)
Peru (90 gün / 180 gün içinde)
Uruguay (90 gün)
Ekvador (90 gün)
Bolivya (90 gün)
Paraguay (90 gün / 180 gün içinde)
Venezuela (90 gün)
Kosta Rika (30 gün, 90 güne kadar uzatılabilir)
El Salvador (90 gün)
Honduras (90 gün)
Nikaragua (90 gün)
Bahamalar
...
Dominika (21 gün)
Jamaika (90 gün)
Trinidad ve Tobago (90 gün / 180 gün içinde)
Saint Kitts ve Nevis (90 gün / 180 gün içinde)
Saint Lucia (6 hafta)
...
Maldivler (30 gün, ücretsiz)
Palau (30 gün)
Güney Afrika Cumhuriyeti (30 gün — sınırda ücretsiz giriş kaşesi)
Mısır
Nepal
Bahreyn
Komor Adaları
Yeşil Burun (Cabo Verde)
Burundi
Madagaskar
Tanzanya
Uganda
...
Türkiye’de kronik hastalıklerin tedavisi ve bu hastalıklarda kullanılan ilaçlar devlet tarafından önemli ölçüde desteklenmektedir. SGK kapsamında karşılanan başlıca kronik hastalıklar şunlardır:
...
BÖLÜM 6. MÜLKİYET HAKKI VEYA GAYRİMENKUL GÜVENCESİ AÇISINDAN SAĞLADIĞI AVANTAJLAR
...
7.5. Lojistik ve Ulaşım Avantajları
Türkiye; Avrupa, Asya, Orta Doğu ve Kuzey Afrika pazarlarına olan coğrafi yakınlığı sayesinde stratejik bir ticaret merkezi konumundadır. Güçlü lojistik altyapısı, geniş limanları, gelişmiş karayolu ağı ve dünya standartlarındaki havayolu taşımacılığı lojistik operasyonları kolaylaştırmaktadır.
...
Gayrimenkul Yatırımı: Türkiye’de en az 400.000 ABD Doları veya karşılığı döviz/Türk Lirası tutarında bir veya birden fazla taşınmazın satın alınması ve tapuda üç yıl süreyle satılmayacağı yönünde şerh konulması gerekmektedir. Taşınmaz değeri, Sermaye Piyasası Kurulu’nun lisansladığı yetkili gayrimenkul değerleme kuruluşları tarafından düzenlenen değerleme raporu ile tespit edilmektedir.
Banka Mevduatı: Türkiye’de faaliyet gösteren bankalarda en az 500.000 ABD Doları veya karşılığı döviz/Türk Lirası tutarında mevduatın bulundurulması ve bu mevduatın üç yıl süreyle çekilmeyeceği yönünde yazılı taahhüt verilmesi gerekmektedir.
Sabit Sermaye Yatırımı: En az 500.000 ABD Doları veya karşılığı döviz/Türk Lirası tutarında sabit sermaye yatırımının gerçekleştirildiğinin Sanayi ve Teknoloji Bakanlığı tarafından tespiti gerekmektedir. Bu yatırım; yeni bir şirket kurulması yoluyla yapılabileceği gibi mevcut bir şirkete sermaye aktarımı yoluyla da gerçekleştirilebilmektedir.
Devlet Borçlanma Araçları: En az 500.000 ABD Doları veya karşılığı döviz/Türk Lirası tutarında devlet borçlanma aracının satın alınması ve üç yıl süreyle elde tutulacağına dair Hazine ve Maliye Bakanlığı’na taahhüt verilmesi gerekmektedir.
Gayrimenkul Yatırım Fonu / Girişim Sermayesi Yatırım Fonu Katılma Payı: En az 500.000 ABD Doları veya karşılığı döviz/Türk Lirası tutarında gayrimenkul yatırım fonu katılma payı veya girişim sermayesi yatırım fonu katılma payının satın alınması ve bu payların üç yıl süreyle elde tutulacağına dair Sermaye Piyasası Kurulu’na taahhüt verilmesi gerekmektedir.
İstihdam Oluşturma: Çalışma ve Sosyal Güvenlik Bakanlığı tarafından en az 50 kişiye istihdam sağlandığının tespit edilmesi gerekmektedir. Bu seçenekte istihdam edilen kişilerin Türk vatandaşı olması ve istihdamın belirlenen süre boyunca sürdürülmesi şartı aranmaktadır.
...
function is_heading($line) {
    return preg_match('/^(BÖLÜM \d+\.|SONUÇ:|\d+\.\d+\.)/u', $line);
}

function should_start_numbered_list($line, $nextLine = null) {
    return (substr($line, -1) === ':') && 
           ($nextLine !== null) && 
           (!is_heading($nextLine)) && 
           (mb_strlen($nextLine) < 120);
}

function build_passport_sections(string $text): array {
    ...
    for ($index = 0; $index < count($lines); $index++) {
        $line = $lines[$index];
        $nextLine = isset($lines[$index + 1]) ? $lines[$index + 1] : null;
        ...
        if (is_heading($line)) {
            if (!empty($current['title']) || !empty($current['paragraphs'])) {
                $sections[] = array_merge(['type' => 'intro'], $current);
            }
            $current = ['title' => $line, 'paragraphs' => []];
            continue;
        }
        
        if (should_start_numbered_list($line, $nextLine)) {
            ...
            while ($cursor < count($lines)) {
                $itemLine = $lines[$cursor];
                $nextItemLine = isset($lines[$cursor + 1]) ? $lines[$cursor + 1] : null;
                
                if (is_heading($itemLine) || should_start_numbered_list($itemLine, $nextItemLine)) {
                    break;
                }
                
                if (mb_strlen($itemLine) > 140 && count($items) > 0) {
                    break;
                }
                
                $items[] = ['title' => $itemLine];
                $cursor++;
            }
            
            if (count($items) > 0) {
                $sections[] = ['type' => 'numbered', 'items' => $items];
                $index = $cursor - 1;
            }
            continue;
        }
    ...
    if ($current !== null && (!empty($current['title']) || !empty($current['paragraphs']))) {
        $sections[] = array_merge(['type' => 'intro'], $current);
    }
...
$sections = build_passport_sections($PASSPORT_ADVANTAGES_TEXT);
?>
      ...
      <section class="relative overflow-hidden border-b border-gray-100 bg-white pt-8 pb-12">
        <div class="relative mx-auto max-w-6xl px-6">
          ...
          <nav class="mb-8 flex items-center gap-1.5 text-xs text-gray-400" aria-label="Breadcrumb">
            ...
            <span>/</span>
            <span class="text-gray-700 font-medium"><?= htmlspecialchars(__t('nav.item_cit_passport') ?? 'Türk Pasaportunun Avantajları') ?></span>
          </nav>

          <!-- Başlık -->
          <h1 class="text-3xl font-extrabold leading-tight tracking-tight text-gray-950 md:text-4xl">
            <?= htmlspecialchars(__t('nav.item_cit_passport') ?? 'Türk Pasaportunun Avantajları') ?>
          </h1>
