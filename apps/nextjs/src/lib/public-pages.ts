...
function mapArticle(article: Article): PublicEntry {
  ...
  return {
    ...
    coverImage: article.coverImage || "/news1.webp",
    tags: article.tags,
...
function mapBulletin(bulletin: Bulletin): PublicEntry {
  ...
  return {
    ...
    coverImage: bulletin.coverImage || "/news2.webp",
    tags: bulletin.tags,
